...
},{"lodash._basecopy":2,"lodash._basetostring":3,"lodash._basevalues":4,"lodash._isiterateecall":5,"lodash._reinterpolate":6,"lodash.keys":8,"lodash.restparam":12,"lodash.templatesettings":13}],2:[function(require,module,exports){
/**
...
},{"lodash._basetostring":3}],8:[function(require,module,exports){
/**
...
},{"lodash._reinterpolate":6,"lodash.escape":7}],14:[function(require,module,exports){
'use strict';
...
var JSONFormatter = (function () {
  function JSONFormatter(json, open, key, config) {
  ...
  _createClass(JSONFormatter, [{
    ...
    value: function template() {
      ...
      return (0, _lodashTemplate2['default'])(templateString).call(this).replace(/\s*\n/g, '\n'); // clean up empty lines
    }
  }, {
    key: 'render',
    ...
    value: function appendChildern() {
      ...
      this.keys.forEach(function (key) {
        var formatter = new JSONFormatter(_this2.json[key], _this2.open - 1, key, _this2.config);
